    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Credit Note Document</h5>
            ...
            <div class="card-body">
                ...
                <!-- Navigation Tabs -->
                <ul class="nav nav-tabs" id="creditNoteTabs" role="tablist">
                    <?php
                    $tabs = [
                        ['id' => 'all-cn', 'icon' => 'file-invoice-dollar', 'label' => 'All CN Document', 'active' => true],
                    ];
                    foreach ($tabs as $tab): ?>
                ...
                <!-- Tab Content -->
                <div class="tab-content" id="creditNoteTabContent">
                    <?php
                    $tabContents = [
                        ['id' => 'all-cn', 'tableId' => 'cnTable', 'overlayId' => 'loadingOverlay1', 'filter' => 'all', 'title' => 'All Data', 'active' => true]
                    ];
                        ...
                        <div class="tab-pane fade <?= $content['active'] ? 'show active' : '' ?>"
                            ...
                            <div class="export-container">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <small class="text-muted me-3">Download CN data:</small>
                                    ...
                                    <?php if (auth()->isAdmin() || auth()->hasRoles(['Admin02'])) { ?>
                                        <a target="_blank" href="<?= base_url('/api-cn') ?>"
                                        ...
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                $headers = [
                                                    ...
                                                    ['text' => 'Clearing<br>Date'],
                                                    ['text' => 'Doc<br>Year'],
                                                    ['text' => 'Vendor'],
                                                    ['text' => 'Currency'],
                                                    ['text' => 'Commission', 'class' => 'text-end'],
                                                    ['text' => 'Text'],
                                                ];
...
<script>
    class CreditNoteReport {
        ...
        getTableConfig() {
            ...
            return {
                ...
                buttons: [{
                        ...
                        title: 'Credit Note Report (Current Page)',
                        exportOptions: {
                            columns: ':visible'
                        }
                    },
        ...
        createTable(tableId, filter, overlayId) {
            return $(`#${tableId}`).DataTable({
                ...this.getTableConfig(),
                ajax: {
                    url: `${this.baseUrl}/report-cn/data`,
                    type: 'POST',
                    timeout: 60000,
                    data: (d) => {
        ...
        initTables() {
            try {
                this.tables['all'] = this.createTable('cnTable', 'all', 'loadingOverlay1');
            } catch (error) {
        ...
        refreshCache() {
            ...
            $.ajax({
                url: `${this.baseUrl}/report-cn/refresh-cache`,
                type: 'POST',
                timeout: 60000,
                data: {
        ...
        handleExport(e) {
            ...
            window.location.href = `${this.baseUrl}/report-cn/export-${exportType}?filter=${tableType}`;
    ...
    $(document).ready(() => {
        try {
            new CreditNoteReport();
        } catch (error) {
            console.error('Error initializing CreditNoteReport:', error);
        }
    });
</script>
<?= $this->endSection() ?>